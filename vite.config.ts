...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@context/interfaces": `${path.resolve(__dirname, "./src/context/interfaces.ts")}`,
      "@customHooks": path.resolve(__dirname, "./src/hooks/index.ts"),
      "@pages": path.resolve(__dirname, "./src/pages/"),
      "@auth/components": path.resolve(__dirname, "./src/pages/auth/components/index.ts"),
      "@chat/components": path.resolve(__dirname, "./src/pages/chat/components/index.ts"),
